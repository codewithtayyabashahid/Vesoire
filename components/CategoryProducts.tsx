      ...
      <div className="flex flex-col md:min-w-40 border">
        {categories?.map((item) => (
          <Button
            ...
            className={`bg-transparent border-0 rounded-none text-white shadow-none hover:bg-white hover:text-black font-semibold hoverEffect border-b last:border-b-0 ${item?.slug?.current === currentSlug && "bg-darkColor text-white border-darkColor"}`}
          >
            {item?.title}
          </Button>
        ))}
